...
class train_cfg:
    # data
    img_size = 224
    root = r"/home/tan/datasets/MTARSI/airplane-datasets-new"
...
def train(local_rank):
    ...
    if cfg.dataset_type == "MNIST":
        ...
        train_images_path, train_images_label, val_images_path, val_images_label = read_split_three_data(cfg.root, train_val_rate = 0.8, train_rate = 0.75)
    ...
    for epoch in range(cfg.start_epoch, cfg.epochs):
        ...
        # 保存断点数据
        if (epoch + 1) % 1 == 0:
            save_path = r"./weights/weights_resnet50"
